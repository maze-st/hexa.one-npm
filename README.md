...
## Usage
In order to use all available endpoints by [HEXA.ONE](https://hexa.one) you will need personal `{key}`. Check [https://hexa.one/user](https://hexa.one/user) section on [HEXA.ONE](https://hexa.one) to get one.
...
## Request
Requests are pointed to `https://hexa.one/api/v1/{endpoint}` where `{endpoint}` is URL from the list below.

## Authentication
All requests require `X-API-Key` header in format `X-API-Key: {key}`.
...
```json
{
  "result": {
    ...
    "avatar": {
      "large": "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/7d/7dad4a2e01ea0fc381de494caca6f62799433696_full.jpg",
      "medium": "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/7d/7dad4a2e01ea0fc381de494caca6f62799433696_medium.jpg",
      "small": "https://steamcdn-a.akamaihd.net/steamcommunity/public/images/avatars/7d/7dad4a2e01ea0fc381de494caca6f62799433696.jpg"
    },
    "balance": 115.86199999999945,
    "name": "YaneonY",
    "profile": "https://steamcommunity.com/id/YaneonY/",
    "roles": ["admin"]
  }
}
```
  ...
  "result": [
    {
      ...
      "created": "2021-10-27T12:30:27.211Z"
    },
    {
      "url": "/user/inventory/76561198019728505/730/2",
      "ip": "127.0.0.1",
      "code": 200,
      "useragent": "HEXA.ONE NodeJS Package",
      "created": "2021-10-27T12:24:34.292Z"
    },
    [...]
  ]
}
...
### [GET] /api/v1/market/currencies/{CODE}
Params:
```
...
### [GET] /api/v1/market/items/{APP_ID}
Params:
```
...
### [GET] /api/v1/market/prices/{APP_ID}
Params:
```
{APP_ID} - Steam Application ID code.
```
...
### [GET] /api/v1/market/listings/{APP_ID}
Params:
```
{APP_ID} - Steam Application ID code.
```
...
### [GET] /api/v1/user/profile/{STEAM_ID}
Params:
```
...
### [GET] /api/v1/user/inventory/{STEAM_ID}/{APP_ID}/{CONTEXT_ID}
Params:
```
{STEAM_ID} - Steam ID in steamID64 format.
{APP_ID} - Steam Application ID code.
